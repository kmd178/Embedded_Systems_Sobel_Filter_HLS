...
#ifndef __sobel_mul_mul_11seOg__HH__
#define __sobel_mul_mul_11seOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mul_mul_11seOg) {
    ...
    SC_CTOR(sobel_mul_mul_11seOg):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
