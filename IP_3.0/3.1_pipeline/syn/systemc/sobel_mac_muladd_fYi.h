...
#ifndef __sobel_mac_muladd_fYi__HH__
#define __sobel_mac_muladd_fYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mac_muladd_fYi) {
    ...
    SC_CTOR(sobel_mac_muladd_fYi):  simcore_mac_0_U ("simcore_mac_0_U") {
