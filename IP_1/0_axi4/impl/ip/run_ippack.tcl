...
set IPName      "sobel"
set Version     "1.0"
set DisplayName "0_axi4"
set Revision    "1706112354"
set Description "Axi4 communication protocol constraints, default C code synthesis"
set Device      "zynq"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_INPUT_BUNDLE m_axi_OUTPUT_BUNDLE"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_INPUT_BUNDLE {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_INPUT_BUNDLE"
        data_width "32"
        param_prefix "C_M_AXI_INPUT_BUNDLE"
    ...
    m_axi_OUTPUT_BUNDLE {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_OUTPUT_BUNDLE"
        data_width "32"
        param_prefix "C_M_AXI_OUTPUT_BUNDLE"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 334236925 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Embedded_Systems_Sobel_Filter_HLS/IP_1st_restructure.c}
if {$enable_xo_gen} {
