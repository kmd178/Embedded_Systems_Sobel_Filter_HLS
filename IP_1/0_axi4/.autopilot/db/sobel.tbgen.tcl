...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "8", "9", "10", "11"],
		"CDFG" : "sobel",
		...
		"VariableLatency" : "1",
		"WaitState" : [
			{"State" : "ap_ST_fsm_state4", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_convolution2D_fu_160"},
			{"State" : "ap_ST_fsm_state6", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_convolution2D_fu_160"}],
		"Port" : [
			{"Name" : "INPUT_BUNDLE", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_convolution2D_fu_160", "Port" : "input_r"}]},
			...
			{"Name" : "horiz_operator", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "6", "SubInstance" : "grp_convolution2D_fu_160", "Port" : "operator"}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sobel_AXILiteS_s_axi_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sobel_INPUT_BUNDLE_m_axi_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sobel_OUTPUT_BUNDLE_m_axi_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_convolution2D_fu_160", "Parent" : "0", "Child" : ["7"],
		"CDFG" : "convolution2D",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "None", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
	...
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_convolution2D_fu_160.sobel_mul_8ns_32sbkb_U0", "Parent" : "6"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sobel_sitodp_32nsdEe_U6", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sobel_dsqrt_64ns_eOg_U7", "Parent" : "0"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sobel_mul_32s_32sfYi_U8", "Parent" : "0"},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sobel_mul_32s_32sfYi_U9", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	sobel {
		INPUT_BUNDLE {Type I LastRead 11 FirstWrite -1}
		OUTPUT_BUNDLE {Type O LastRead 55 FirstWrite 50}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "334236925", "Max" : "334236925"}
	, {"Name" : "Interval", "Min" : "334236926", "Max" : "334236926"}
]}
