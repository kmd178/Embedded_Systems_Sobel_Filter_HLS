...
#ifndef __sobel_sitodp_32nsdEe__HH__
#define __sobel_sitodp_32nsdEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_sitodp_32nsdEe) {
    ...
    SC_CTOR(sobel_sitodp_32nsdEe):  ACMP_sitodp_U ("ACMP_sitodp_U") {
