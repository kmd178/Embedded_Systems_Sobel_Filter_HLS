...
#ifndef __sobel_mul_32s_32sfYi__HH__
#define __sobel_mul_32s_32sfYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mul_32s_32sfYi) {
    ...
    SC_CTOR(sobel_mul_32s_32sfYi):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
