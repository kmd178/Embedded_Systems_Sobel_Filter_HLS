...
#ifndef __sobel_mul_8ns_32sbkb__HH__
#define __sobel_mul_8ns_32sbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_mul_8ns_32sbkb) {
    ...
    SC_CTOR(sobel_mul_8ns_32sbkb):  ACMP_mul_us_U ("ACMP_mul_us_U") {
