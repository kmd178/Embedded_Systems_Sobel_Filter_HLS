...
#ifndef __sobel_sitodp_32s_bkb__HH__
#define __sobel_sitodp_32s_bkb__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_sitodp_32s_bkb) {
    ...
    SC_CTOR(sobel_sitodp_32s_bkb):  ACMP_sitodp_U ("ACMP_sitodp_U") {
