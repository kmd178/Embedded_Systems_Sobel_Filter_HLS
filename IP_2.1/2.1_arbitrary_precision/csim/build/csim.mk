...
HLS_SOURCES = ../../../../testbench.c ../../../../IP_2.1_arbitrary_precision.c
...
$(ObjDir)/IP_2.1_arbitrary_precision.o: ../../../../IP_2.1_arbitrary_precision.c $(ObjDir)/.dir
	$(Echo) "   Compiling(apcc) ../../../../IP_2.1_arbitrary_precision.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(AUTOCC) -c -MMD  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/IP_2.1_arbitrary_precision.d
