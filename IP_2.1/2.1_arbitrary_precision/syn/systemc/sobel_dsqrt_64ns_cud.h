...
#ifndef __sobel_dsqrt_64ns_cud__HH__
#define __sobel_dsqrt_64ns_cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_dsqrt_64ns_cud) {
    ...
    SC_CTOR(sobel_dsqrt_64ns_cud):  ACMP_dsqrt_U ("ACMP_dsqrt_U") {
